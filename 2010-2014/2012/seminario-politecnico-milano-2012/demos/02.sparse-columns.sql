------------------------------------------------------------------------
-- Script:			02.sparse-columns.sql
-- Last update:		2012-01-20
-- Author:			Gianluca Hotz  (SolidQ)
-- Credits:			
-- Copyright:		Attribution-NonCommercial-ShareAlike 3.0
-- Versions:		SQL2008 RTM + CU1
--
-- Description:		Demonstrate Sparse Columns vs EAV
------------------------------------------------------------------------
...
------------------------------------------------------------------------
-- Of couse we can still access both spare and non sparse columns.
------------------------------------------------------------------------
SELECT
	P1.ProductID
,	P1.ProductName
