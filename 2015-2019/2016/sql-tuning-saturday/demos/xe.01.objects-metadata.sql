...
--
	...
	SELECT	XP.name, XP.[guid], XP.[description], LM.name
	FROM	sys.dm_xe_packages AS XP
...
-- 
	...
	--	Mappe definite per le proprieta' dell'evento SQL Server 2012/2014 per 2008R2
	--	sostituire GUID 03FDA7D0-91BA-45F8-9875-8B6DD0B8E9F2 con 655FD93F-3364-40D5-B2BA-330F7FFB6491
