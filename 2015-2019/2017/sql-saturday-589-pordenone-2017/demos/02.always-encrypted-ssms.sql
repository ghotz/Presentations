...
--
--	The step-by-step instructions for the Always Encrypet demo are available at
...
-- SSMS V17 (vNext) has "Parameterization for Always Encrypted" Query Options
