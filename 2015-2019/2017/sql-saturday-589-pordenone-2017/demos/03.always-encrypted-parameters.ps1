...
$ConnectionString = "Data Source=localhost\sql2016;Initial Catalog=Clinic;Column Encryption Setting=Enabled;User ID=ContosoClinicApplication;Password=Passw0rd1";
