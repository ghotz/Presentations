...
#Get-AzureRmSqlDatabaseActivity -ServerName "azuredbdemo" -ResourceGroupName "AzureDBDemoResources" -ElasticPoolName "AzureDBDemoPool" -DatabaseName "AzureDemoDB02" 
cls;
