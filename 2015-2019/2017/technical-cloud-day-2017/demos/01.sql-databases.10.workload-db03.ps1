...
$connectionString = "Server=tcp:" + "azuredbdemo" + ".database.windows.net" + ",1433;Initial Catalog=" + "AzureDemoDB03" + ";Persist Security Info=False;User ID=ghotz;Password=Passw0rd!" + ";MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;"
